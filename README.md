...
**Jika Anda memerlukan tambahan module lagi dalam repo atau Jika Anda menemukan bug, silahkan report di group [@KyuraSupport2](https://www.telegram.dog/KyuraSupport2)**
...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Kyuraxp/kyura4fileshare)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/Kyuraxp/kyura4fileshare
cd kyura4fileshare
...
## Support   
Bergabunglah di [@KyuraSupport2](https://www.telegram.dog/KyuraSupport2) Untuk Dukungan/Bantuan Dan Join [@KyuraProject](https://www.telegram.dog/KyuraProject) untu info Update bot.   
...
[FILE-SHARING-BOT](https://github.com/Kyuraxp/kyura4fileshare) is Free Software: You can use, study share and improve it at your
